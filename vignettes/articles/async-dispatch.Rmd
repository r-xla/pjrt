...
|----------------|-----------------|---------|
| `pjrt_buffer()` | `pjrt_buffer_async()` | `PJRTBufferPromise` |
| `pjrt_execute()` | `pjrt_execute_async()` | `PJRTBufferPromise` |
...
- **Buffer promises** (`PJRTBufferPromise`): The buffer is valid immediately - PJRT handles dependencies internally. R returns immediately without blocking.
