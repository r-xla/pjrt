...
knitr::opts_chunk$set(
  collapse = TRUE,
  comment = "#>",
  eval = pjrt::plugins_downloaded("cpu")
)
```
...
Note that compilation depends on the specific device.
...
```{r, eval = requireNamespace("safetensors", quietly = TRUE) && pjrt::plugins_downloaded("cpu")}
