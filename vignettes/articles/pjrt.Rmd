...
Anyone can implement a PJRT plugin for a specific hardware backend, and this package currently supports CPU, NVIDIA GPU, and MPS (Apple GPU; experimental) plugins.
