...
Use [`value()`](https://r-xla.github.io/pjrt/reference/value.md) to get
the R array (blocks if not ready). Use
[`is_ready()`](https://r-xla.github.io/pjrt/reference/is_ready.md) to
...
[`value()`](https://r-xla.github.io/pjrt/reference/value.md) to get the
R array.
