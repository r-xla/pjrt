...
RcppExport SEXP _pjrt_impl_plugin_client_create(SEXP pluginSEXP) {
  ...
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
  Rcpp::traits::input_parameter<Rcpp::XPtr<rpjrt::PJRTPlugin> >::type plugin(
      pluginSEXP);
...
RcppExport SEXP _pjrt_impl_program_repr(SEXP programSEXP, SEXP nSEXP) {
  ...
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
  Rcpp::traits::input_parameter<Rcpp::XPtr<rpjrt::PJRTProgram> >::type program(
      programSEXP);
...
Rcpp::XPtr<rpjrt::PJRTBuildOptions> impl_build_options_create(
    const int num_replicas, const int num_partitions, const int device_ordinal);
RcppExport SEXP _pjrt_impl_build_options_create(SEXP num_replicasSEXP,
                                                SEXP num_partitionsSEXP,
                                                SEXP device_ordinalSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
  Rcpp::traits::input_parameter<const int>::type num_replicas(num_replicasSEXP);
  Rcpp::traits::input_parameter<const int>::type num_partitions(
      num_partitionsSEXP);
  Rcpp::traits::input_parameter<const int>::type device_ordinal(
      device_ordinalSEXP);
...
RcppExport SEXP _pjrt_impl_compile_options_create(SEXP build_optionsSEXP) {
  ...
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
  Rcpp::traits::input_parameter<Rcpp::XPtr<rpjrt::PJRTBuildOptions> >::type
      build_options(build_optionsSEXP);
...
RcppExport SEXP _pjrt_impl_client_program_compile(SEXP clientSEXP,
                                                  SEXP programSEXP,
                                                  SEXP compile_optionsSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
  Rcpp::traits::input_parameter<Rcpp::XPtr<rpjrt::PJRTClient> >::type client(
      clientSEXP);
  Rcpp::traits::input_parameter<Rcpp::XPtr<rpjrt::PJRTProgram> >::type program(
      programSEXP);
  Rcpp::traits::input_parameter<Rcpp::XPtr<rpjrt::PJRTCompileOptions> >::type
      compile_options(compile_optionsSEXP);
  rcpp_result_gen =
      Rcpp::wrap(impl_client_program_compile(client, program, compile_options));
  return rcpp_result_gen;
  END_RCPP
}
...
Rcpp::XPtr<rpjrt::PJRTBuffer> impl_client_buffer_from_double(
    ...
    std::string type);
RcppExport SEXP _pjrt_impl_client_buffer_from_double(SEXP clientSEXP,
                                                     SEXP dataSEXP,
                                                     SEXP dimsSEXP,
                                                     SEXP typeSEXP) {
  BEGIN_RCPP
  ...
  rcpp_result_gen =
      Rcpp::wrap(impl_client_buffer_from_double(client, data, dims, type));
  return rcpp_result_gen;
  END_RCPP
}
...
Rcpp::XPtr<rpjrt::PJRTBuffer> impl_client_buffer_from_integer(
    Rcpp::XPtr<rpjrt::PJRTClient> client, SEXP data, std::vector<int64_t> dims,
    std::string type);
RcppExport SEXP _pjrt_impl_client_buffer_from_integer(SEXP clientSEXP,
                                                      SEXP dataSEXP,
                                                      SEXP dimsSEXP,
                                                      SEXP typeSEXP) {
  BEGIN_RCPP
  ...
  Rcpp::traits::input_parameter<std::string>::type type(typeSEXP);
  rcpp_result_gen =
      Rcpp::wrap(impl_client_buffer_from_integer(client, data, dims, type));
  return rcpp_result_gen;
  END_RCPP
}
...
Rcpp::XPtr<rpjrt::PJRTBuffer> impl_client_buffer_from_logical(
    Rcpp::XPtr<rpjrt::PJRTClient> client, SEXP data, std::vector<int64_t> dims,
    std::string type);
RcppExport SEXP _pjrt_impl_client_buffer_from_logical(SEXP clientSEXP,
                                                      SEXP dataSEXP,
                                                      SEXP dimsSEXP,
                                                      SEXP typeSEXP) {
  BEGIN_RCPP
  ...
  Rcpp::traits::input_parameter<std::string>::type type(typeSEXP);
  rcpp_result_gen =
      Rcpp::wrap(impl_client_buffer_from_logical(client, data, dims, type));
  return rcpp_result_gen;
  END_RCPP
}
...
RcppExport SEXP _pjrt_impl_client_buffer_to_host(SEXP clientSEXP,
                                                 SEXP bufferSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
  Rcpp::traits::input_parameter<Rcpp::XPtr<rpjrt::PJRTClient> >::type client(
      clientSEXP);
  Rcpp::traits::input_parameter<Rcpp::XPtr<rpjrt::PJRTBuffer> >::type buffer(
      bufferSEXP);
...
RcppExport SEXP _pjrt_impl_loaded_executable_execute(SEXP executableSEXP,
                                                     SEXP inputSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
  Rcpp::traits::input_parameter<Rcpp::XPtr<rpjrt::PJRTLoadedExecutable> >::type
      executable(executableSEXP);
  Rcpp::traits::input_parameter<Rcpp::List>::type input(inputSEXP);
  rcpp_result_gen =
      Rcpp::wrap(impl_loaded_executable_execute(executable, input));
  return rcpp_result_gen;
  END_RCPP
}
...
RcppExport SEXP _pjrt_impl_element_type_as_string(SEXP element_typeSEXP) {
  ...
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
  Rcpp::traits::input_parameter<Rcpp::XPtr<rpjrt::PJRTElementType> >::type
      element_type(element_typeSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_pjrt_impl_plugin_client_create",
     (DL_FUNC)&_pjrt_impl_plugin_client_create, 1},
    {"_pjrt_impl_program_load", (DL_FUNC)&_pjrt_impl_program_load, 2},
    {"_pjrt_impl_program_repr", (DL_FUNC)&_pjrt_impl_program_repr, 2},
    {"_pjrt_impl_build_options_create",
     (DL_FUNC)&_pjrt_impl_build_options_create, 3},
    {"_pjrt_impl_compile_options_create",
     (DL_FUNC)&_pjrt_impl_compile_options_create, 1},
    {"_pjrt_impl_client_program_compile",
     (DL_FUNC)&_pjrt_impl_client_program_compile, 3},
    {"_pjrt_impl_client_buffer_from_double",
     (DL_FUNC)&_pjrt_impl_client_buffer_from_double, 4},
    {"_pjrt_impl_client_buffer_from_integer",
     (DL_FUNC)&_pjrt_impl_client_buffer_from_integer, 4},
    {"_pjrt_impl_client_buffer_from_logical",
     (DL_FUNC)&_pjrt_impl_client_buffer_from_logical, 4},
    {"_pjrt_impl_client_buffer_to_host",
     (DL_FUNC)&_pjrt_impl_client_buffer_to_host, 2},
    {"_pjrt_impl_client_platform_name",
     (DL_FUNC)&_pjrt_impl_client_platform_name, 1},
    {"_pjrt_impl_loaded_executable_execute",
     (DL_FUNC)&_pjrt_impl_loaded_executable_execute, 2},
    {"_pjrt_impl_buffer_element_type", (DL_FUNC)&_pjrt_impl_buffer_element_type,
     1},
    {"_pjrt_impl_element_type_as_string",
     (DL_FUNC)&_pjrt_impl_element_type_as_string, 1},
