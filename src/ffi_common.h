...
//
// The patterns here mirror the ones in jaxlib (jaxlib/cpu/lapack_kernels.cc and
// jaxlib/gpu/solver_kernels_ffi.cc): an Error-returning macro for
// status-returning calls, a bounds-checked int64 -> int cast, and a
// dispatch-by-element-type macro that reduces an op's f32/f64 boilerplate to a
// one-line switch.
#pragma once
