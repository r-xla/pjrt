...
#' @return `PJRTBuffer`
#' @export
pjrt_buffer <- function(data, type, client = pjrt_client("cpu"), ...) {
  check_client(client)
...
#' @rdname pjrt_buffer
#' @export
pjrt_scalar <- function(data, type, client = pjrt_client("cpu"), ...) {
  check_client(client)
...
#' @template param_client
#' @export
buffer_to_host <- function(buffer, client = pjrt_client("cpu")) {
  check_client(client)
