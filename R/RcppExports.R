...
impl_cuda_set_named_module <- function(name, id) {
    invisible(.Call(`_pjrt_impl_cuda_set_named_module`, name, id))
}
...
impl_cuda_module_add_prebuilt <- function(id, targets, images, lowered) {
    invisible(.Call(`_pjrt_impl_cuda_module_add_prebuilt`, id, targets, images, lowered))
}

impl_cuda_module_origins <- function(id) {
    .Call(`_pjrt_impl_cuda_module_origins`, id)
}

impl_cuda_compile <- function(source, filename, options, kernels, target) {
    .Call(`_pjrt_impl_cuda_compile`, source, filename, options, kernels, target)
}
